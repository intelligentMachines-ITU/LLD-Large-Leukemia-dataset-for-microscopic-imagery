    ...
    for path, im, im0s, vid_cap, s, orig_img in dataset:
        ...
        with dt[1]:
            ...
            if model.xml and im.shape[0] > 1:
                ...
                pred,int_feats,_ = model(im, augment=augment, visualize=visualize)
        # NMS
        with dt[2]:
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/only_RG_loss_final2/weights/last.pt', help='model path or triton URL')
    parser.add_argument('--source', type=str, default='SOD_16/images/test', help='file/dir/URL/glob/screen/0(webcam)')
