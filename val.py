...
def run(
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        with dt[1]:
            ...
            (preds, train_out),int_feats,deep_feats = model(im) if compute_loss else (model(im, augment=augment), None) #I changed here
        ...
        # Loss
        # if compute_loss:
        #     loss += compute_loss(train_out, targets[:,0:10])[1]  # box, obj, cls # I changed here

        # NMS
        attribute_targets = targets[:,11:17]
